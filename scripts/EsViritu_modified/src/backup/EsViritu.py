...
def esviritu():
    ...
    logger.info("STEP finished: fastp_stats")
    ...
    logger.info("STEP finished: various_readstats")
    ...
    logger.info("STEP finished: initial minimap2_f")
    ...
    logger.info("STEP finished: initial assembly_read_sharing_table")
    ...
    logger.info("STEP finished: initial cluster_assemblies_by_read_sharing")
    ...
    logger.info("STEP finished: initial clust_record_getter")
    ...
    logger.info("STEP finished: second minimap2_f")
    ...
    logger.info("STEP finished: second assembly_read_sharing_table")
    ...
    logger.info("STEP finished: second cluster_assemblies_by_read_sharing")
    ...
    logger.info("STEP finished: second clust_record_getter")
    ...
    logger.info("STEP finished: third minimap2_f")
    ...
    logger.info("STEP finished: bam_to_consensus_fasta")
    ...
    logger.info("STEP finished: bam_to_coverm_table")
    ...
    logger.info("STEP finished: bam_coverage_windows")
    ...
    logger.info("STEP finished: read_ani_from_bam")
    ...
    logger.info("STEP finished: assembly_table_maker")
    ...
    logger.info("STEP finished: tax_profile")
    ...
    if completedProc.returncode == 0 :
        ...
        logger.info("STEP finished: reactable report")
